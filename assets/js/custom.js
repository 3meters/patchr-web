...
$('.mailchimp').ajaxChimp({
    ...
    url: "http://candipatch.us6.list-manage2.com/subscribe/post?u=1df8ada498d190cdfea7149aa&amp;id=164aa1f4bc"
});
...
if (matchMedia('(min-width: 992px), (max-width: 767px)').matches) {
  function mainNav() {
        ...
        if (top >= 0) $('.sticky-navigation').stop().animate({"top": '0'});
...
//    $(document).ready(function() {
//     var videobackground = new $.backgroundVideo($('video-explainer'), {
//       "align": "centerXY",
//       "width": 1280,
//       "height": 720,
//       "path": "video/",
